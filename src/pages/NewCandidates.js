    ...
    return (
        <Container fluid >
            ...
            <Row style={{textAlign: 'left', color: 'white', backgroundColor: '#16A2B8', padding: '20px' }}>
                <Col>
                    <Form noValidate validated={validated} onSubmit={handleSubmit} style={{ backgroundColor: '#16A2B8' }}>
                        ...
                        <Button type="submit" variant="outline-light" style={{ backgroundColor: '#16A2B8', }} >Submit form</Button>
                    </Form>
                </Col>
            </Row>
        </Container>
